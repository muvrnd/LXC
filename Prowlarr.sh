...
$STD wget --content-disposition 'https://github.com/Prowlarr/Prowlarr/releases/tag/v1.31.2.4975'
$STD tar -xvzf Prowlarr.master.1.31.2.4975.freebsd-core-x64.tar.gz
mv Prowlarr /opt
